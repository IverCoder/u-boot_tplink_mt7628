...
int initTpProduct(void)
{
...
#elif defined(TP_MODEL_WR840NV5) || defined(TP_MODEL_WR840NV6)
	/* GPIO Mode */
	gpiomode = le32_to_cpu(*(volatile u32 *)(RALINK_SYSCTL_BASE + 0x60));
	gpiomode |= (1 << 14) | (1 << 16) | (1 << 18);
	*(volatile u32 *)(RALINK_SYSCTL_BASE + 0x60) = cpu_to_le32(gpiomode);
	...
	*(volatile u32 *)(RALINK_PIO_BASE + 0x4) = tmp;
	...
	/* light Led Orange, 41 is high and 43 is highZ. set 43 to input */
	setGpioData(41, 1);
	tmp = le32_to_cpu(*(volatile u32 *)(RALINK_PIO_BASE + 0x4));
	tmp &= ~(1 << (43-32));
	*(volatile u32 *)(RALINK_PIO_BASE + 0x4) = tmp;
	...
	*(volatile u32 *)(RALINK_PIO_BASE + 0x4) = tmp;
	...
	/* light Led Orange, 40 is high and 42 is highZ. set 42 to input */
	setGpioData(40, 1);
	tmp = le32_to_cpu(*(volatile u32 *)(RALINK_PIO_BASE + 0x4));
	tmp &= ~(1 << (42-32));
	*(volatile u32 *)(RALINK_PIO_BASE + 0x4) = tmp;
   ...
   */  
    ...
    *(volatile u32 *)(RALINK_SYSCTL_BASE + 0x64) = cpu_to_le32(gpiomode);   
    ...
    /* GPIO CTRL 1 for GPIO 32~64 OUTPUT */
    tmp = le32_to_cpu(*(volatile u32 *)(RALINK_PIO_BASE + 0x4));
    tmp |= ((1 << (40 - 32)) | (1 << (41 - 32)) | (1 << (43 - 32)) | (1 << (44 - 32)) );
    *(volatile u32 *)(RALINK_PIO_BASE + 0x4) = tmp;
    ...
    *(volatile u32 *)(RALINK_PIO_BASE + 0x4) = tmp;
    ...
    setGpioData(43, 1);
    udelay (500 * 100 * 10); /* 1s */
    /* Internet color switch */
    /* light Led Orange,  41 high, 43 dir input */
    setGpioData(41, 1);
	tmp = le32_to_cpu(*(volatile u32 *)(RALINK_PIO_BASE + 0x4));
	tmp &= ~(1 << (43-32));
	*(volatile u32 *)(RALINK_PIO_BASE + 0x4) = tmp;    
    ...
    setGpioData(40, 1);
    setGpioData(41, 1);
    /* turn off  Led Orange, 43 dir output && high */
	tmp = le32_to_cpu(*(volatile u32 *)(RALINK_PIO_BASE + 0x4));
	tmp |= (1 << (43-32));
	*(volatile u32 *)(RALINK_PIO_BASE + 0x4) = tmp;    
    setGpioData(43, 1);
...
/* GPIO
 * GPIO11: POWER LED
 * GPIO39:INTERNET GREEN LED
 * GPIO40:INTERNET ORANGE LED
 * GPIO41:LAN LED
 * GPIO42:WLAN 5G LED
 * GPIO43:WPS LED
	...
	*(volatile u32 *)(RALINK_PIO_BASE + 0x24) = tmp;
	...
	setGpioData(57, 1);
...
#elif defined(TP_MODEL_C55V1) || defined(TP_MODEL_C6V1) || defined(TP_MODEL_A1201V1)
		...
		*(volatile u32 *)(RALINK_PIO_BASE + 0x24) = tmp;
		...
		udelay (1000 * 100 * 5);
		setGpioData(1, 1);
		//setGpioData(7, 1); /*keep power led on.*/
		setGpioData(11, 1);
		setGpioData(14, 1);
		setGpioData(17, 1);
		setGpioData(39, 1);
...
#else
/* else default same as MT7628_ASIC_BOARD */
int getGpioData(u32 gpio, u32 *data)
{
	u32 bit = 0;
	u32 reg = 0;
